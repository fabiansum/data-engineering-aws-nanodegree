...
staging_events_copy = ("""
    ...
    REGION 'us-west-2' FORMAT AS JSON '{log_jsonpath}'
...
business_queries = [most_played_song, highest_usage_time_of_day, top_5_most_active_users, most_popular_artist, song_play_count_by_location]
